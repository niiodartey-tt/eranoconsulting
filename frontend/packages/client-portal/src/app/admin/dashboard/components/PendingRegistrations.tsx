          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6 space-y-2">
                <div><span className="font-medium">Business:</span> {selectedRegistration.business_name}</div>
                <div><span className="font-medium">Contact:</span> {selectedRegistration.full_name}</div>
              ...
              {tempPassword && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                  <h4 className="font-semibold text-green-900 mb-2">Registration Approved!</h4>
                  <p className="text-sm text-green-800 mb-3">
                    Temporary password has been sent to the client's email:
                  </p>
                  <div className="bg-white rounded p-3 font-mono text-lg text-center border border-green-300">
                    {tempPassword}
                  </div>
