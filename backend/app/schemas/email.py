...
class EmailService:
    ...
    async def send_registration_confirmation(email: str, business_name: str):
        ...
        logger.info(f"   Body: Your registration has been received and is pending admin verification.")
        return True
    ...
    async def send_temporary_credentials(
        ...
        logger.info(f"   Note: You will be required to change your password on first login.")
        return True
